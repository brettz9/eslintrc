...
describe("FlatCompat", () => {
    ...
    describe("config()", async () => {
        ...
        const pluginFixture1 = normalizePlugin((await import(path.join(baseDirectory, "node_modules/eslint-plugin-fixture1.js"))).default);
        const pluginFixture2 = normalizePlugin((await import(path.join(baseDirectory, "node_modules/eslint-plugin-fixture2.js"))).default);
        const pluginFixture3 = normalizePlugin((await import(path.join(baseDirectory, "node_modules/eslint-plugin-fixture3.js"))).default);
        ...
        describe("languageOptions", () => {
            ...
            it("should translate parser string into an object", async () => {
                ...
                assert.deepStrictEqual(result[0], {
                    languageOptions: {
                        parser: (await import(getFixturePath("config/node_modules/my-parser.js"))).default
                    }
                });
            });
    ...
    describe("plugins()", () => {
            ...
            assert.deepStrictEqual(result[0], {
                plugins: {
                    fixture1: {
                        ...
                        environments: {},
                        processors: {},
                        ...(await import(path.join(compat.baseDirectory, "node_modules/eslint-plugin-fixture1.js"))).default
                    }
                }
            });
        });
        ...
        it("should translate plugins with processors", async () => {
            ...
            const plugin = (await import(path.join(compat.baseDirectory, "node_modules/eslint-plugin-fixture2.js"))).default;
